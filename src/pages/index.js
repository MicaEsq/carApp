...
function CarsView() {
  ...
  const [filtersApplied, setFiltersApplied] = useState(new Set)
    ...
    <>
      ...
      <main className="flex flex-row justify-between">
        <div className="hidden lg:block md:w-full md:px-[37px] ">
          <Filters data={formattFilters(data.items)} setFiltersApplied={setFiltersApplied} filtersApplied={filtersApplied}/>
        </div>
        <div className="mt-16 pl-6 pr-6 lg:pl-0 lg:pr-14">
          ...
          {layout === "grid" ?
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5 w-auto" data-testid="cars-list">
              {data.items.map((e) => {
                return <CardCuadricula product={e}/>;
              })}
            </div>
            :
            <div className="flex flex-col" data-testid="cars-list"> 
              {data.items.map((e) => {
                return <><CardHorizontal product={e}/><hr className="w-full bg-[#E3E5ED]"/></>;
              })}
            </div>
          }
        </div>

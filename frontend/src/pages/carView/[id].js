          ...
          <div className="w-full lg:col-span-3 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
              ...
              <div className='flex flex-row gap-20 ml-5'>
                <ul role="list" className="list-disc space-y-2 pl-4 mt-4 text-md">
                  ...
                  <li className="text-gray-400">
                    ...
                    {carData.financing  && <Link href="" className="flex flex-row mt-1 items-center text-sm font-bold text-[#566DED]">
                ...
                <ul role="list" className="list-disc space-y-2 mt-4 ml-14 text-md">
                  <li className="text-gray-400">
            ...
            <div className="mt-10 pb-5 w-full lg:border-b lg:border-gray-200">
              <h2 className="text-lg font-bold text-gray-900">Observations</h2>
                <p className='font-medium mt-2 text-gray-700'>{carData.observation ? carData.observation : 'None'}</p> 
            </div>

...
function CarView() {
  ...
  return (
    ...
    {carData.length !== 0 ? <div className="bg-white">
      <div className="flex flex-row pt-6">
        {/* Image gallery */}
        <div className='w-1/2 max-w-4xl md:w-full md:px-[60px]'>
          <Carousel image={carData.image}></Carousel>
        </div>
        {/* Product info */}
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-4 lg:pb-24 lg:pt-16">
          <div className="pb-5 lg:col-span-2 lg:border-b lg:border-gray-200 lg:pr-8">
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div>
              ...
              <div className='flex flex-row'>
                <ul role="list" className="list-disc space-y-2 pl-4 mt-2 text-md">
                  <li className="text-gray-400">
                    <span className="text-gray-600">Condition: {carData.condition}</span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">Mileage: {carData.mileage} km</span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">Transmission: {carData.transmission}</span>
                  </li>
                  {/* <li className="text-gray-400">
                    <span className="text-gray-600">Color: {carData.color}</span>
                  </li> */}
                  <li className="text-gray-400">
                    <span className="text-gray-600 flex items-center">Financing: {carData.financing ? 'Yes' : 'No'}{carData.financing  && <Link href="" className="flex flex-row items-center ml-1 text-sm font-bold text-[#566DED]">
                ...
                <ul role="list" className="list-disc space-y-2 pl-4 mt-2 text-md">
                  ...
                  <li className="text-gray-400">
                    <span className="text-gray-600">Capacity: {carData.capacity}</span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">Type of fuel: {carData.fuel}</span>
                  </li> */}
                </ul>
              </div>
            </div>
            <div className="mt-10 pb-5 lg:border-b lg:border-gray-200">
              <h2 className="text-lg font-bold text-gray-900">Observations</h2>
                {/* <p>{carData.observations}</p> */}
            </div>
            {/* Options */}
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              <div className="flex flex-row gap-3">
                <button
                  type="submit"
                  className="mt-10 flex w-full items-center justify-center rounded-md border border-indigo-500 text-indigo-500 px-8 py-3 text-base font-medium hover:bg-indigo-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Agregar a favoritos
                </button>
                <button
